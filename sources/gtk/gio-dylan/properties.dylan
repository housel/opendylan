...
define property-getter protocol-version :: <GTlsProtocolVersion> on <GTlsConnection> end;
...
define property-getter negotiated-protocol :: <C-string> on <GTlsConnection> end;
...
define property-getter ciphersuite-name :: <C-string> on <GTlsConnection> end;
...
define property-setter advertised-protocols :: <C-string*> on <GTlsConnection> end;
define property-getter advertised-protocols :: <C-string*> on <GTlsConnection> end;
define property-getter subject-name :: <C-string> on <GTlsCertificate> end;
define property-setter private-key-pkcs11-uri :: <C-string> on <GTlsCertificate> end;
define property-getter private-key-pkcs11-uri :: <C-string> on <GTlsCertificate> end;
define property-setter private-key-pem :: <C-string> on <GTlsCertificate> end;
define property-getter private-key-pem :: <C-string> on <GTlsCertificate> end;
define property-setter private-key :: <GByteArray> on <GTlsCertificate> end;
define property-getter private-key :: <GByteArray> on <GTlsCertificate> end;
define property-setter pkcs12-data :: <GByteArray> on <GTlsCertificate> end;
define property-setter pkcs11-uri :: <C-string> on <GTlsCertificate> end;
define property-getter pkcs11-uri :: <C-string> on <GTlsCertificate> end;
define property-setter password :: <C-string> on <GTlsCertificate> end;
define property-getter not-valid-before :: <GDateTime> on <GTlsCertificate> end;
define property-getter not-valid-after :: <GDateTime> on <GTlsCertificate> end;
define property-getter issuer-name :: <C-string> on <GTlsCertificate> end;
...
define property-getter ip-addresses :: <GPtrArray> on <GTlsCertificate> end;
define property-getter dns-names :: <GPtrArray> on <GTlsCertificate> end;
...
define property-getter completed :: <C-boolean> on <GTask> end;
define property-setter flags :: <GSubprocessFlags> on <GSubprocessLauncher> end;
define property-setter flags :: <GSubprocessFlags> on <GSubprocess> end;
define property-setter argv :: <C-string*> on <GSubprocess> end;
define property-setter active :: <C-boolean> on <GSocketService> end;
define property-getter active :: <C-boolean> on <GSocketService> end;
...
define property-setter output-stream :: <GOutputStream> on <GSimpleIOStream> end;
define property-getter output-stream :: <GOutputStream> on <GSimpleIOStream> end;
define property-setter input-stream :: <GInputStream> on <GSimpleIOStream> end;
define property-getter input-stream :: <GInputStream> on <GSimpleIOStream> end;
...
define property-setter backend :: <GSettingsBackend> on <GSettings> end;
define property-getter backend :: <GSettingsBackend> on <GSettings> end;
...
define property-setter default-port :: <C-unsigned-int> on <GProxyAddressEnumerator> end;
define property-getter default-port :: <C-unsigned-int> on <GProxyAddressEnumerator> end;
...
define property-getter state-type :: <GVariantType> on <GPropertyAction> end;
define property-getter state :: <GVariant> on <GPropertyAction> end;
define property-setter property-name :: <C-string> on <GPropertyAction> end;
define property-getter parameter-type :: <GVariantType> on <GPropertyAction> end;
define property-setter object :: <GObject> on <GPropertyAction> end;
define property-setter name :: <C-string> on <GPropertyAction> end;
define property-getter name :: <C-string> on <GPropertyAction> end;
define property-setter invert-boolean :: <C-boolean> on <GPropertyAction> end;
define property-getter invert-boolean :: <C-boolean> on <GPropertyAction> end;
define property-getter enabled :: <C-boolean> on <GPropertyAction> end;
...
define property-setter pim :: <C-unsigned-int> on <GMountOperation> end;
define property-getter pim :: <C-unsigned-int> on <GMountOperation> end;
...
define property-setter is-tcrypt-system-volume :: <C-boolean> on <GMountOperation> end;
define property-getter is-tcrypt-system-volume :: <C-boolean> on <GMountOperation> end;
define property-setter is-tcrypt-hidden-volume :: <C-boolean> on <GMountOperation> end;
define property-getter is-tcrypt-hidden-volume :: <C-boolean> on <GMountOperation> end;
...
define property-getter n-items :: <C-unsigned-int> on <GListStore> end;
define property-setter item-type :: <C-long> on <GListStore> end;
define property-getter item-type :: <C-long> on <GListStore> end;
...
define property-setter connection :: <GDBusConnection> on <GDebugControllerDBus> end;
define property-getter connection :: <GDBusConnection> on <GDebugControllerDBus> end;
...
define property-getter flags :: <GDBusConnectionFlags> on <GDBusConnection> end;
...
define property-setter bytes :: <GBytes> on <GBytesIcon> end;
define property-getter bytes :: <GBytes> on <GBytesIcon> end;
...
define property-setter options :: <GVariant> on <GApplicationCommandLine> end;
...
define property-setter resource-base-path :: <C-string> on <GApplication> end;
define property-getter resource-base-path :: <C-string> on <GApplication> end;
...
define property-getter is-busy :: <C-boolean> on <GApplication> end;
