...
define module pango
  ...
  export
    ...
    pango-attr-text-transform-new,
    pango-attr-style-new,
    pango-attr-strikethrough-new,
    pango-attr-strikethrough-color-new,
    pango-attr-stretch-new,
    pango-attr-show-new,
    pango-attr-sentence-new,
    pango-attr-scale-new,
    pango-attr-rise-new,
    pango-attr-overline-new,
    pango-attr-overline-color-new,
    pango-attr-line-height-new-absolute,
    pango-attr-line-height-new,
    pango-attr-letter-spacing-new,
    pango-attr-insert-hyphens-new,
    pango-attr-gravity-new,
    pango-attr-gravity-hint-new,
    pango-attr-foreground-new,
    pango-attr-foreground-alpha-new,
    pango-attr-font-scale-new,
    pango-attr-family-new,
    pango-attr-fallback-new,
    pango-attr-break,
    pango-attr-baseline-shift-new,
    pango-attr-background-new,
    pango-attr-background-alpha-new,
    pango-attr-allow-breaks-new,
    <PangoWrapMode*>,
    <PangoWrapMode>,
    ...
    <PangoVariant*>,
    <PangoVariant>,
    $pango-variant-title-caps,
    $pango-variant-unicase,
    $pango-variant-all-petite-caps,
    $pango-variant-petite-caps,
    $pango-variant-all-small-caps,
    ...
    <PangoUnderline*>,
    <PangoUnderline>,
    $pango-underline-error-line,
    $pango-underline-double-line,
    $pango-underline-single-line,
    ...
    <PangoTextTransform*>,
    <PangoTextTransform>,
    $pango-text-transform-capitalize,
    $pango-text-transform-uppercase,
    $pango-text-transform-lowercase,
    $pango-text-transform-none,
    pango-tab-array-from-string,
    pango-tab-array-to-string,
    pango-tab-array-sort,
    pango-tab-array-set-tab,
    pango-tab-array-set-positions-in-pixels,
    pango-tab-array-set-decimal-point,
    ...
    pango-tab-array-get-decimal-point,
    ...
    <PangoShowFlags*>,
    <PangoShowFlags>,
    $pango-show-ignorables,
    $pango-show-line-breaks,
    $pango-show-spaces,
    $pango-show-none,
    <PangoShapeFlags*>,
    <PangoShapeFlags>,
    $pango-shape-round-positions,
    $pango-shape-none,
    ...
    $pango-script-old-hungarian,
    $pango-script-multani,
    $pango-script-hatran,
    $pango-script-anatolian-hieroglyphs,
    $pango-script-ahom,
    $pango-script-warang-citi,
    $pango-script-tirhuta,
    $pango-script-siddham,
    $pango-script-psalter-pahlavi,
    $pango-script-pau-cin-hau,
    $pango-script-palmyrene,
    $pango-script-pahawh-hmong,
    $pango-script-old-permic,
    $pango-script-old-north-arabian,
    $pango-script-nabataean,
    $pango-script-mro,
    $pango-script-modi,
    $pango-script-mende-kikakui,
    $pango-script-manichaean,
    $pango-script-mahajani,
    $pango-script-linear-a,
    $pango-script-khudawadi,
    $pango-script-khojki,
    $pango-script-grantha,
    $pango-script-elbasan,
    $pango-script-duployan,
    $pango-script-caucasian-albanian,
    $pango-script-bassa-vah,
    $pango-script-takri,
    ...
    pango-matrix-scale,
    pango-matrix-rotate,
    pango-matrix-get-slant-ratio,
    pango-matrix-get-font-scale-factors,
    ...
    pango-matrix-xx,
    <PangoMatrix>,
    pango-log-attr-reserved-setter,
    pango-log-attr-reserved,
    pango-log-attr-break-removes-preceding-setter,
    pango-log-attr-break-removes-preceding,
    pango-log-attr-break-inserts-hyphen-setter,
    pango-log-attr-break-inserts-hyphen,
    ...
    <PangoLayoutSerializeFlags>,
    $pango-layout-serialize-output,
    $pango-layout-serialize-context,
    $pango-layout-serialize-default,
    ...
    pango-layout-line-get-resolved-direction,
    pango-layout-line-get-pixel-extents,
    pango-layout-line-get-length,
    pango-layout-line-get-height,
    ...
    pango-layout-iter-get-run-baseline,
    ...
    <PangoLayoutDeserializeFlags>,
    $pango-layout-deserialize-context,
    $pango-layout-deserialize-default,
    <PangoLayoutDeserializeError*>,
    <PangoLayoutDeserializeError>,
    $pango-layout-deserialize-missing-value,
    $pango-layout-deserialize-invalid-value,
    $pango-layout-deserialize-invalid,
    <PangoLayoutClass>,
    pango-layout-xy-to-index,
    pango-layout-write-to-file,
    ...
    pango-layout-set-line-spacing,
    pango-layout-set-justify-last-line,
    ...
    $pango-gravity-east,
    $pango-gravity-south,
    pango-glyph-vis-attr-is-color-setter,
    pango-glyph-vis-attr-is-color,
    ...
    pango-glyph-string-index-to-x-full,
    ...
    pango-glyph-item-end-x-offset-setter,
    pango-glyph-item-end-x-offset,
    pango-glyph-item-start-x-offset-setter,
    pango-glyph-item-start-x-offset,
    pango-glyph-item-y-offset-setter,
    pango-glyph-item-y-offset,
    ...
    pango-fontset-simple-size,
    pango-fontset-simple-append,
    pango-fontset-simple-new,
    <PangoFontsetSimple*>,
    <PangoFontsetSimple>,
    pango-fontset-class-_pango-reserved4,
    pango-fontset-class-_pango-reserved3,
    pango-fontset-class-_pango-reserved2,
    pango-fontset-class-_pango-reserved1,
    pango-fontset-class-foreach,
    pango-fontset-class-get-language,
    pango-fontset-class-get-metrics,
    pango-fontset-class-get-font,
    pango-fontset-class-parent-class,
    <PangoFontsetClass>,
    ...
    <PangoFontScale*>,
    <PangoFontScale>,
    $pango-font-scale-small-caps,
    $pango-font-scale-subscript,
    $pango-font-scale-superscript,
    $pango-font-scale-none,
    ...
    pango-font-metrics-underline-position,
    pango-font-metrics-approximate-digit-width,
    pango-font-metrics-approximate-char-width,
    pango-font-metrics-height,
    pango-font-metrics-descent,
    pango-font-metrics-ascent,
    pango-font-metrics-ref-count,
    <PangoFontMetrics>,
    <PangoFontMask*>,
    <PangoFontMask>,
    $pango-font-mask-variations,
    ...
    pango-font-map-class-get-face,
    pango-font-map-class-get-family,
    pango-font-map-class-changed,
    pango-font-map-class-get-serial,
    pango-font-map-class-shape-engine-type,
    pango-font-map-class-load-fontset,
    pango-font-map-class-list-families,
    pango-font-map-class-load-font,
    pango-font-map-class-parent-class,
    <PangoFontMapClass>,
    pango-font-map-load-fontset,
    pango-font-map-load-font,
    pango-font-map-list-families,
    pango-font-map-get-serial,
    pango-font-map-get-family,
    pango-font-map-create-context,
    pango-font-map-changed,
    <PangoFontMap*>,
    <PangoFontMap>,
    pango-font-family-class-_pango-reserved2,
    pango-font-family-class-get-face,
    pango-font-family-class-is-variable,
    pango-font-family-class-is-monospace,
    pango-font-family-class-get-name,
    pango-font-family-class-list-faces,
    pango-font-family-class-parent-class,
    ...
    pango-font-family-get-face,
    <PangoFontFamily*>,
    <PangoFontFamily>,
    pango-font-face-class-_pango-reserved4,
    pango-font-face-class-_pango-reserved3,
    pango-font-face-class-get-family,
    pango-font-face-class-is-synthesized,
    pango-font-face-class-list-sizes,
    pango-font-face-class-describe,
    pango-font-face-class-get-face-name,
    pango-font-face-class-parent-class,
    <PangoFontFaceClass>,
    pango-font-face-list-sizes,
    pango-font-face-is-synthesized,
    pango-font-face-get-family,
    ...
    pango-font-description-set-variations-static,
    pango-font-description-set-variations,
    ...
    pango-font-description-get-variations,
    ...
    pango-font-class-create-hb-font,
    pango-font-class-get-features,
    pango-font-class-describe-absolute,
    pango-font-class-get-font-map,
    pango-font-class-get-metrics,
    pango-font-class-get-glyph-extents,
    pango-font-class-get-coverage,
    pango-font-class-describe,
    pango-font-class-parent-class,
    <PangoFontClass>,
    pango-font-serialize,
    pango-font-has-char,
    pango-font-get-metrics,
    pango-font-get-languages,
    pango-font-get-glyph-extents,
    pango-font-get-font-map,
    pango-font-get-features,
    pango-font-get-face,
    ...
    <PangoCoverage>,
    <PangoContextClass>,
    pango-context-set-round-glyph-positions,
    ...
    pango-context-get-round-glyph-positions,
    ...
    <PangoBaselineShift*>,
    <PangoBaselineShift>,
    $pango-baseline-shift-subscript,
    $pango-baseline-shift-superscript,
    $pango-baseline-shift-none,
    pango-attribute-init,
    pango-attribute-equal,
    pango-attribute-destroy,
    pango-attribute-copy,
    pango-attribute-as-string,
    pango-attribute-as-size,
    pango-attribute-as-shape,
    pango-attribute-as-language,
    pango-attribute-as-int,
    pango-attribute-as-font-features,
    pango-attribute-as-font-desc,
    pango-attribute-as-float,
    pango-attribute-as-color,
    ...
    <PangoAttrType*>,
    <PangoAttrType>,
    $pango-attr-font-scale,
    $pango-attr-baseline-shift,
    $pango-attr-sentence,
    $pango-attr-word,
    $pango-attr-text-transform,
    $pango-attr-absolute-line-height,
    $pango-attr-line-height,
    $pango-attr-overline-color,
    $pango-attr-overline,
    $pango-attr-insert-hyphens,
    $pango-attr-show,
    $pango-attr-allow-breaks,
    $pango-attr-background-alpha,
    $pango-attr-foreground-alpha,
    $pango-attr-font-features,
    ...
    pango-attr-list-get-attributes,
    pango-attr-list-filter,
    pango-attr-list-equal,
    ...
    pango-attr-int-attr,
    <PangoAttrInt>,
    pango-attr-font-features-new,
    pango-attr-font-features-features-setter,
    pango-attr-font-features-features,
    pango-attr-font-features-attr-setter,
    pango-attr-font-features-attr,
    ...
    $pango-align-center,
    $pango-align-left,
    $attr-index-to-text-end,
    $attr-index-from-text-beginning,
    $analysis-flag-need-hyphen,
    $analysis-flag-is-ellipsis,
    $analysis-flag-centered-baseline;
end module;

define module pango-properties
  use pango;
  use gobject-glue;
